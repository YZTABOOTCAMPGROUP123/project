...
# =================================================================
# ⚙️ MODEL ENTEGRASYON VE YÜKLEME KATMANI
# =================================================================
...
if os.path.exists(MODEL_PATH) and os.path.exists(ENCODER_PATH):
    try:
        ...
        # Modelin eğittiği feature listesini tam sırada almak için
        MODEL_FEATURES = ml_model.feature_names_in_.tolist()
        USE_ML = True
    except Exception:
        # Yükleme sırasında beklenmedik bir hata olursa çökme, kuralsal modele geç
        USE_ML = False
else:
    USE_ML = False
